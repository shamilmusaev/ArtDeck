...
(обложки, баннеры, hero, logo, icon) из [SteamGridDB](https://www.steamgriddb.com)
...
- 🖼️ **Визуальный выбор артов** — сетка вариантов с SteamGridDB по 5 типам
  (обложка, баннер, hero, logo, icon), с предпросмотром в лайтбоксе.
