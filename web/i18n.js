...
const I18N = {
  ru: {
    ...
    import_steam_stuck: "Не удалось закрыть Steam, импорт отменён. Закройте Steam вручную и повторите.",
  ...
  en: {
    ...
    import_steam_stuck: "Couldn't close Steam, import cancelled. Close Steam manually and retry.",
