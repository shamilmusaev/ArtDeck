...
const I18N = {
  ru: {
    ...
    import_dialog_title: "Импорт игр (%d)",
    import_dialog_collection: "Добавить в коллекцию Steam",
    import_collection_name_label: "Имя коллекции",
    import_collection_hint: "Игры попадут в коллекцию библиотеки Steam с этим именем (создастся, если её ещё нет)",
    import_steam_will_restart: "Steam будет закрыт и снова открыт",
    import_confirm: "Импортировать",
    import_collection_done: "Добавлены в коллекцию: %s",
  ...
  en: {
    ...
    import_dialog_title: "Import games (%d)",
    import_dialog_collection: "Add to a Steam collection",
    import_collection_name_label: "Collection name",
    import_collection_hint: "The games go into a Steam library collection with this name (created if it doesn't exist yet)",
    import_steam_will_restart: "Steam will be closed and reopened",
    import_confirm: "Import",
    import_collection_done: "Added to collection: %s",
